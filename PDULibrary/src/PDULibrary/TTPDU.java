...
public class TTPDU implements PDU
{	
	//PROPIEDADES
	...
	//CONSTRUCTORES
	public TTPDU( DatagramPacket tmpPDU, DatagramSocket UDPServer, String IPServidor )
	{
		try{
	...
	public TTPDU( DatagramPacket tmpPDU )
	{
		InitPDU( tmpPDU );
		
	}
		
	public TTPDU( byte[] tmpPDU )
	{
		try{
